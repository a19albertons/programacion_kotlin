...
fun arriba2(tablero: MutableList<MutableList<Char>>,i:Int,j:Int): Boolean{
    //                    Arriba
...
fun abajo2(tablero: MutableList<MutableList<Char>>, i: Int, j: Int): Boolean {
    //                    Abajo
    var breakcontrol = false
...
fun derecha2(tablero: MutableList<MutableList<Char>>, i: Int, j: Int): Boolean {
    //                    Derecha
    var breakcontrol = false
...
fun izquierda2(tablero: MutableList<MutableList<Char>>, i: Int, j: Int): Boolean {
    //                    Izquierda
    var breakcontrol = false
...
fun arribaDerecha2(tablero: MutableList<MutableList<Char>>, i: Int, j: Int, y:Int): Boolean {
//    arriba_derecha
    var breakcontrol=false
    var contador = 0
...
fun abajoDerecha2(tablero: MutableList<MutableList<Char>>, i: Int, j: Int, x:Int, y: Int): Boolean {
    //                    abajo_derecha
    var breakcontrol=false
    var contador=0
...
fun arribaIzquierda2(tablero: MutableList<MutableList<Char>>, i: Int, j: Int): Boolean {
    //                    arriba_izquierda
    var breakcontrol=false
    var contador=0
...
fun abajoIzquierda2(tablero: MutableList<MutableList<Char>>, i: Int, j: Int, x: Int): Boolean {
    //                  abajo_izquierda
    var breakcontrol=false
    var contador=0
