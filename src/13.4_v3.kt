fun getSimetrica(original: Array<CharArray>): MutableList<MutableList<Char>> {
...
fun imprimirFiguras(original: Array<CharArray>, simetrica: MutableList<MutableList<Char>>) {
    for (i in 0..original.lastIndex) {
