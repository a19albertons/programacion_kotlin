...
//        Tras analizar coderunner plan de contigencias ante un aparente error humano
        while ("" in lista_sombras) {
            val modificar = lista_sombras.toMutableList()
            modificar.remove("")
            lista_sombras=modificar
        }
//        Añadimo los arboles
